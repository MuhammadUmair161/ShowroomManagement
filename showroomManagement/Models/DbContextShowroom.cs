...
{
    public partial class DbContextShowroom : IdentityDbContext<ApplicationUser>
    {
      
        public DbContextShowroom(DbContextOptions<DbContextShowroom> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=ShowroomDb;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccessoriesStock>(entity =>
            {
                ...
                entity.HasOne(d => d.Accessory)
                    ...
                    .HasConstraintName("FK__Accessori__Acces__6FE99F9F");
            });
            ...
            modelBuilder.Entity<Interst>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Intersts__UserId__68487DD7");
            });
            ...
            modelBuilder.Entity<Invoice>(entity =>
            {
                ...
                entity.HasOne(d => d.Car)
                    ...
                    .HasConstraintName("FK__Invoice__CarId__6383C8BA");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Invoices)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("FK__Invoice__Custome__656C112C");

                entity.HasOne(d => d.InvoiceGeneratedByNavigation)
                    .WithMany(p => p.Invoices)
                    .HasForeignKey(d => d.InvoiceGeneratedBy)
                    .HasConstraintName("FK__Invoice__Invoice__6477ECF3");
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.OrdereAccessory)
                    ...
                    .HasConstraintName("FK__Orders__OrdereAc__73BA3083");

                entity.HasOne(d => d.OrderedByNavigation)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.OrderedBy)
                    .HasConstraintName("FK__Orders__OrderedB__72C60C4A");
            });
            ...
            modelBuilder.Entity<RegisteredCar>(entity =>
            {
                ...
                entity.HasOne(d => d.Car)
                    ...
                    .HasForeignKey(d => d.CarId)
                    .HasConstraintName("FK__Registere__CarId__6B24EA82");
            });
